...
estilos_label1.configure('Label1.TLabel', font="ariel 15 ", anchor="e")

estilos_label2 = ttk.Style()
estilos_label2.configure('Label2.TLabel', font="ariel 40 ", anchor="e")
...
estilos_botones_numero = ttk.Style()
estilos_botones_numero.configure('Botones_numeros.TButton', font="arial 22", width=5, background="#FFFFFF", relief= "flat" )
...
estilos_botones_restante = ttk.Style()
estilos_botones_restante.configure('Botones_restante.TButton',font="arial 22", width=5, relief= "flat",background="#CECECE")
...
button_parentesis1 = ttk.Button(mainframe, text="(", style="Botones_restante.TButton")
button_parentesis2 = ttk.Button(mainframe, text=")",style="Botones_restante.TButton")
button_punto = ttk.Button(mainframe, text=".",style="Botones_restante.TButton")

button_division = ttk.Button(mainframe, text=chr(247),style="Botones_restante.TButton")
button_multiplicacion = ttk.Button(mainframe, text="x",style="Botones_restante.TButton")
button_suma = ttk.Button(mainframe, text="+",style="Botones_restante.TButton")
button_resta = ttk.Button(mainframe, text="-",style="Botones_restante.TButton")

button_igual = ttk.Button(mainframe, text="=",style="Botones_restante.TButton")
button_raiz_cuadrada = ttk.Button(mainframe, text="√",style="Botones_restante.TButton")

#colocal los botones en pantalla 
